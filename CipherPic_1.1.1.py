"""CipherPic 1.1.1 - Encrypt and decrypt an image
...
def create_app_window():
    ...
    #Edit menu
    edit=tk.Menu(top, tearoff=0)
    menubar.add_cascade(menu=edit,compound="left", label="Edit")
    edit.add_command(compound="left",label="Paste image", command=paste_image, accelerator="Alt+P")
...
def load_image():
    ...
    buffered=BytesIO()
    imgfile.save(buffered,format="PNG")
...
def encode_image():
    ...
    imgdata = base64.b64encode(img_bytes)
...
def aboutbox():
    ...
    url_title.configure(text="CipherPic 1.1.1", font=("Arial",15))
